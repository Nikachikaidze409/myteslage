...
export function DestinationSearch({ onSelect, disabled, origin }: Props) {
  ...
  return (
    <div className="relative">
      <div className="flex h-16 w-full items-center rounded-2xl border border-border bg-card/90 px-6 shadow-xl shadow-slate-300/40 backdrop-blur-md transition focus-within:ring-2 focus-within:ring-primary/30">
