...
export const UI = {
  ka: {
    ...
    savedLocation: "შენახული ადგილი",
    add: "დამატება",
    selectPlaceFirst: "ჯერ მონიშნე ადგილი რუკაზე",
    noSavedLocations: "შენახული ადგილები ჯერ არ არის.",
    recent: "ბოლო",
    nameThisPlace: "დაარქვი ამ ადგილს სახელი",
    cancel: "გაუქმება",
    save: "შენახვა",
    removeSavedLocation: "შენახული ადგილის წაშლა",
  },
  en: {
    back: "← Back",
    ...
    add: "Add",
    selectPlaceFirst: "Select a place on the map first",
  ...
  hy: {
    ...
    savedLocation: "Պահված վայր",
    add: "Ավելացնել",
    selectPlaceFirst: "Նախ նշեք վայրը քարտեզի վրա",
    noSavedLocations: "Պահված վայրեր դեռ չկան։",
    recent: "Վերջինները",
    nameThisPlace: "Անվանեք այս վայրը",
    cancel: "Չեղարկել",
    save: "Պահել",
    removeSavedLocation: "Հեռացնել պահված վայրը",
  },
  ru: {
    back: "← Назад",
    ...
    savedLocation: "Сохранённое место",
    add: "Добавить",
    selectPlaceFirst: "Сначала отметьте место на карте",
    noSavedLocations: "Сохранённых мест пока нет.",
    recent: "Недавние",
    nameThisPlace: "Назовите это место",
    cancel: "Отмена",
    save: "Сохранить",
    removeSavedLocation: "Удалить сохранённое место",
  },
} as const;
