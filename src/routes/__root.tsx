  ...
  head: () => ({
    meta: [
      ...
      { title: "TMap Georgia" },
      {
        name: "description",
        content:
          "Browser-based navigation for compatible Tesla vehicles in Georgia.",
      },
      { name: "author", content: "TMap Georgia" },
      { property: "og:title", content: "TMap Georgia" },
      {
      ...
      { name: "twitter:title", content: "TMap Georgia" },
      { name: "twitter:description", content: "Browser-based navigation for compatible Tesla vehicles in Georgia." },
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window,document,'script','https://connect.facebook.net/en_US/fbevents.js');fbq('init','1469756411676777');fbq('track','PageView');`,
          }}
        />
      </head>
      <body>
        <noscript>
          <img
            ...
            style={{ display: "none" }}
            alt=""
            src="https://www.facebook.com/tr?id=1469756411676777&ev=PageView&noscript=1"
          />
        </noscript>
        {children}
        <Scripts />
